...
from livekit.agents import ( AgentSession, JobContext, JobProcess, RoomInputOptions, RoomOutputOptions, WorkerOptions, cli, metrics, )
...
class AllPurposeAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=ALL_PURPOSE_CONTEXT
        )

    async def on_enter(self):
        await self.session.generate_reply(instructions="Hi, I’m your All Purpose Agent Assistant! How can I help you today?")
...
async def entrypoint(ctx: JobContext):
    ...
    await session.say("Hi, I’m your All Purpose Agent Assistant! How can I help you today?")
